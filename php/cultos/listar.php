...
<body>
  ...
  <section class="intro-interna">
    <div class="container">
      <h1>Cultos</h1>
      <p>lista de cultos cadastrados</p>
...
?>
    ...
    <form action="alterar.php" method="GET">
      ...
      <input type=hidden name=titulo value=<?php echo $array["titulo"]; ?>>

      <input type=hidden name=data value=<?php echo $array["data"]; ?>>

      <input type=hidden name=hora value=<?php echo $array["hora"]; ?>>
